...
```
Python: <module 'numpy' from '/home/crackauc/sandbox/tmp_20260723_161333_68
786/SciMLBenchmarks.jl/benchmarks/Surrogates/.CondaPkg/.pixi/envs/default/l
ib/python3.12/site-packages/numpy/__init__.py'>
```
...
├────────────────────┼──────────────┼─────────────┤
│      Kriging (SMT) │  3.51665e-18 │ 5.68543e-18 │
│ Radial Basis (SMT) │  2.34051e-14 │ 1.72216e-12 │
│        Lobachevsky │   3.7375e-19 │  2.13922e-8 │
│            Kriging │   1.16824e-5 │  1.58745e-5 │
│       Radial Basis │  1.74579e-30 │ 0.000176083 │
│            XGBoost │   0.00176894 │  0.00776917 │
└────────────────────┴──────────────┴─────────────┘
```
...
│              Model │     Time(s) │
├────────────────────┼─────────────┤
│  Original Function │     1.51e-6 │
│            Kriging │ 0.000335777 │
│ Radial Basis (SMT) │ 0.000409507 │
│      Kriging (SMT) │ 0.000703745 │
│        Lobachevsky │  0.00151171 │
│       Radial Basis │  0.00153047 │
│            XGBoost │    0.036631 │
└────────────────────┴─────────────┘
```
