...
```
Status `~/sandbox/tmp_20260723_161333_68786/SciMLBenchmarks.jl/benchmarks/NonStiffDDE/Project.toml`
⌃ [f42792ee] DDEProblemLibrary v0.1.5
⌃ [bcd4f6db] DelayDiffEq v6.0.2
...
```
Status `~/sandbox/tmp_20260723_161333_68786/SciMLBenchmarks.jl/benchmarks/NonStiffDDE/Manifest.toml`
